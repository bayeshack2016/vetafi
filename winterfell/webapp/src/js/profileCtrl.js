...
app.controller('profileCtrl', ['$scope', '$location', '$window', 'profileService', 'claimService', 'net', 'strings', 'ngDialog',
  function($scope, $location, $window, profileService, claimService, net, strings, ngDialog) {
