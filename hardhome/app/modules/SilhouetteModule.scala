...
import utils.auth.{ RedirectSecuredErrorHandler, CustomUnsecuredErrorHandler, DefaultEnv, IdMeProvider }
...
class SilhouetteModule extends AbstractModule with ScalaModule {
  ...
  def provideIdMeProvider(
    ...
    new IdMeProvider(httpLayer, stateProvider, configuration.underlying.as[OAuth2Settings]("silhouette.idme"))
  }
